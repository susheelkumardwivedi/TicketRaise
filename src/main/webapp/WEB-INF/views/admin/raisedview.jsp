...
<body>
	...
	<table border=1 style="margin: 0px auto">
		...
		<tr>
			...
			<th>Comments</th>
		<tr>
			<c:forEach var="allTicket" items="${requestScope.raised}">
				<tr>
					...
					<td width="15%" align="center">${allTicket.user.email}</td>
					...
					<td width="15%" align="center"><a
						href="/TicketRaise/ticket/assign?id=${allTicket.id}">Assign</a>
					<td width="15%" align="center"><a
